    ...
    public void onClick(View view)
    {
        switch (view.getId())
        {
            ...
            case R.id.linearLayout:
                Intent j = new Intent(this, peopledetail.class);
                startActivity(j);
                break;

            case  R.id.linierLayout2:
                Intent k = new Intent(this, peopledetail2.class);
                startActivity(k);
                break;

            case  R.id.linierLayout3:
                Intent l = new Intent(this, peopledetail.class);
                startActivity(l);
                break;

            case  R.id.linierLayout4:
                Intent m = new Intent(this, peopledetail.class);
                startActivity(m);
                break;

            case  R.id.linierLayout5:
                Intent n = new Intent(this, peopledetail.class);
                startActivity(n);
                break;

            case  R.id.linierLayout6:
                Intent o = new Intent(this, peopledetail.class);
                startActivity(o);
                break;
